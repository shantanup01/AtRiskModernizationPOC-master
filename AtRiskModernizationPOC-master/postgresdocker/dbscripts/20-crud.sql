...
--CREATE DATABASE AtRisk WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';


--ALTER DATABASE AtRisk OWNER TO postgres;
...
--ALTER TABLE "DataEventRecords" OWNER TO postgres;
...
--ALTER TABLE "DataEventRecords_DataEventRecordId_seq" OWNER TO postgres;
...
--ALTER TABLE "SourceInfos" OWNER TO postgres;
...
--ALTER TABLE "SourceInfos_SourceInfoId_seq" OWNER TO postgres;
